...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Techgroup";
$MESS["WIZ_COMPANY_TELEPHONE"] = "Телефон для обратной связи";
$MESS["WIZ_COMPANY_TELEPHONE2"] = "Второй телефон для обратной связи";
$MESS["WIZ_COMPANY_TELEPHONE_DEF"] = "+7 (928) 909-44-74";
$MESS["WIZ_COMPANY_TELEPHONE_DEF2"] = "+7 (928) 909-44-74";
...
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; Интернет-магазин Techgroup, 2014";
...
$MESS["wiz_site_desc"] = "TechGroup – это готовое решение для быстрого запуска интернет-магазина электроники, бытовой техники, климатического оборудования, автоаксессуаров, строительной и садовой техники, товаров для спорта, отдыха, туризма и творчества, подарков, бижутерии и много другого. В интернет-магазине «TechGroup» мы объединили лучшие функциональные возможности лидеров интернет-торговли – DNS и Sotmarket.
Александр";
$MESS["wiz_keywords"] = "интернет-магазина электроники, интернет-магазина бытовой техник";
...
$MESS['KRAYT_TP'] = "Хочу получать приоритетную техническую поддержку";
$MESS['KRAYT_TP_TEXT'] = "Ставя галочку, Вы полностью соглашаетесь со всеми условиями";
$MESS['KRAYT_TP_USER'] = "лицензионного соглашения";
$MESS['KRAYT_TP_IF'] = "Если вы хотите, чтобы ваши обращения в техническую поддержку рассматривались первыми, <br> установите галочку:";


$MESS['WIZ_STEP_DEMO_FORM'] = "Персональный менеджер";
$MESS['WIZ_STEP_DEMO_FORM_NAME'] = "Ваше имя*";
$MESS['WIZ_STEP_DEMO_FORM_NAME_E'] = "Поле 'Ваше имя' обязательно к заполнению, минимум 3 символа";
$MESS['WIZ_STEP_DEMO_FORM_PHONE_E'] = "Поле 'Ваш телефон' обязательно к заполнению";
$MESS['WIZ_STEP_DEMO_FORM_EMAIL'] = "Ваш e-mail*";
$MESS['WIZ_STEP_DEMO_FORM_EMAIL_E'] = "Поле 'Ваш e-mail' обязательно к заполнению";
$MESS['WIZ_STEP_DEMO_FORM_EMAIL_E_VALID'] = "Укажите верный e-mail";
$MESS['WIZ_STEP_DEMO_FORM_PHONE'] = "Ваш телефон*";
$MESS['WIZ_STEP_DEMO_FORM_MANAGER'] = "Ваш персональный менеджер";
$MESS['WIZ_STEP_DEMO_FORM_MANAGER_NAME'] = "Екатерина";
$MESS['WIZ_STEP_DEMO_FORM_MANAGER_DESC'] = "Отвечу на вопросы по готовому решению<br><br>
            Расскажу об акциях и скидках";
$MESS['WIZ_STEP_DEMO_FORM_DESC'] = "После отправки данных за вами будет закреплен менеджер, который будет вас сопровождать";
$MESS['WIZ_STEP_DEMO_FORM_DESC_AGREE'] = "Нажимая кнопку «Далее», я даю свое согласие на обработку моих
персональных данных, в соответствии с Федеральным законом от 27.07.2006 года №152-ФЗ «О персональных данных», на условиях и для целей,
определенных в <a href='https://krayt.ru/soglasii-na-obrabotku/'>Согласии на обработку персональных данных</a>.";
$MESS['WIZ_STEP_DEMO_ERROR'] = "Модуль «krayt.sport» не установлен или закончился демо период. <br> Установите модуль «krayt.sport»";
$MESS['WIZ_CURRENCY_TPL'] = "Использовать настройки валюты из шаблона";
?>