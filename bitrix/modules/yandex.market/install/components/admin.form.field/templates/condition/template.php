...
$this->addExternalCss('/bitrix/js/yandex.market/lib/select2/select2.css');
$this->addExternalCss('/bitrix/js/yandex.market/lib/select2/select2.theme.css');
$this->addExternalJs('/bitrix/js/yandex.market/lib/select2/select2.js');
