(function(BX, $, window) {
	...
	var constructor = Param.Node = Reference.Base.extend({
		...
		defaults: {
			...
			fieldSelectTemplate: '<select class="b-param-table__input js-param-node__input js-param-node__field js-plugin" data-plugin="Ui.Input.TagInput" data-width="100%" data-tags="false"></select>',
		...
		destroyValueUi: function(newField) {
			var value = newField || this.getElement('field');
