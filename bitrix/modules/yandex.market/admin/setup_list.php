...
else
{
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'ALLOW_SAVE' => $accessLevel === 'W',
			'PROVIDER_TYPE' => 'Setup',
			'MODEL_CLASS_NAME' => Market\Export\Setup\Model::getClassName(),
			'EDIT_URL' => '/bitrix/admin/yamarket_setup_edit.php?lang=' . LANGUAGE_ID . '&id=#ID#',
			'ADD_URL' => '/bitrix/admin/yamarket_setup_edit.php?lang=' . LANGUAGE_ID,
			...
			'ROW_ACTIONS' => array(
				'RUN' => array(
					'URL' => '/bitrix/admin/yamarket_setup_run.php?lang=' . LANGUAGE_ID . '&id=#ID#',
					'ICON' => 'unpack',
					'TEXT' => Loc::getMessage('YANDEX_MARKET_ADMIN_SETUP_LIST_ROW_ACTION_RUN')
				),
				'EDIT' => array(
					'URL' => '/bitrix/admin/yamarket_setup_edit.php?lang=' . LANGUAGE_ID . '&id=#ID#',
					'ICON' => 'edit',
					'TEXT' => Loc::getMessage('YANDEX_MARKET_ADMIN_SETUP_LIST_ROW_ACTION_EDIT'),
					'DEFAULT' => true
				),
				'COPY' => array(
					'URL' => '/bitrix/admin/yamarket_setup_edit.php?lang=' . LANGUAGE_ID . '&id=#ID#&copy=Y',
					'ICON' => 'copy',
